...
export default function Client() {
  ...
  const handleSubmit = async () => {
    ...
    try { await fetch("/api/leads", { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ name, email, phone, issue: `Print Email/Webpage — App: ${app} — Device: ${device}`, source: "how-to-print-email-or-webpage" }) }); } catch {}
