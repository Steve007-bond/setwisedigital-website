...
export default function Client() {
  ...
  const handleSubmit = async () => {
    ...
    try { await fetch("/api/leads", { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ name, email, phone, issue: `GPS Upgrade — Verdict: ${getVerdict()}`, source: "gps-upgrade-decider" }) }); } catch (e) { console.error("[lead] error:", e); }
