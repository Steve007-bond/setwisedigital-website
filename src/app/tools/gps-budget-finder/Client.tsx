...
export default function Client() {
  ...
  const handleSubmit = async () => {
    ...
    try { await fetch("/api/leads", { method:"POST", headers:{"Content-Type":"application/json"}, body: JSON.stringify({ name, email, phone, issue: `GPS Budget Finder — Budget: ${selectedBudget?.label}`, source:"gps-budget-finder" }) }); } catch {}
