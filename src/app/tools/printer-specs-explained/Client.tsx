...
export default function Client() {
  ...
  const handleSubmit = async () => {
    ...
    try { await fetch("/api/leads", { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ name, email, phone, issue: `Printer Specs Guide — Viewed: ${viewedCount} terms`, source: "printer-specs-explained" }) }); } catch {}
