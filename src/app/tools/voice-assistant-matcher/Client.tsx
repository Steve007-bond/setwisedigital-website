...
export default function Client() {
  ...
  const handleSubmit = async () => {
    ...
    try { await fetch("/api/leads",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({name,email,phone,brand:topPick?.name,issue:`Voice Matcher — Top Pick: ${topPick?.name}`,source:"voice-assistant-matcher"})}); } catch (e) { console.error("[lead] error:", e); }
