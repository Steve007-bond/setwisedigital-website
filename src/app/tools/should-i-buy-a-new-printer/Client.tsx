...
export default function Client() {
  ...
  const handleSubmit = async () => {
    ...
    try { await fetch("/api/leads", { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ name, email, phone, issue: `Replace vs Keep — Verdict: ${result?.verdict} — Age: ${answers.age} — Problems: ${answers.problems}`, source: "should-i-buy-a-new-printer" }) }); } catch {}
