      ...
      <main className="pt-44 pb-32 mesh-gradient">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-start">
            ...
            {/* Right Side: Contact Form — now fully wired */}
            <motion.div
              initial={{ opacity: 0, x: 50 }}
              animate={{ opacity: 1, x: 0 }}
              transition={{ duration: 0.8, ease: "easeOut" }}
                    ...
                    <form onSubmit={handleSubmit} className="space-y-10" noValidate>
                      ...
                      <div className="space-y-4">
                        ...
                        <textarea
                          ...
                          className="w-full px-10 py-6 bg-zinc-50 border-2 border-transparent rounded-[3rem] focus:outline-none focus:border-blue-600 focus:bg-white transition-all font-bold text-xl resize-none shadow-inner"
                        />
                      </div>
                      ...
                      <button
                        ...
                        className={`shine-effect w-full py-8 rounded-[3rem] font-black text-3xl flex items-center justify-center gap-3 transition-all active:scale-[0.98] ${
                      ...
                      >
                        {formStatus === "loading" ? (
                          <><Loader2 size={28} className="animate-spin" />Sending...</>
                        ) : (
